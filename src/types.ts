...
const colorBackgroundRecord: Record<ColorBackgroundAlias | "", 1> = {
  ...
  "bg-surface": 1,
  "button-gradient-bg-fill-active-experimental": 1,
  "button-gradient-bg-fill-selected-experimental": 1,
...
const colorBorderRecord: Record<ColorBorderAlias | "", 1> = {
  "tooltip-tail-up-border-experimental": 1,
  "tooltip-tail-down-border-experimental": 1,
  "input-border": 1,
  ...
  "border-info": 1,
  "border-hover": 1,
  "border-gradient-selected-experimental": 1,
  "border-gradient-hover-experimental": 1,
  "border-gradient-experimental": 1,
  "border-gradient-active-experimental": 1,
  "border-focus": 1,
  "border-emphasis": 1,
